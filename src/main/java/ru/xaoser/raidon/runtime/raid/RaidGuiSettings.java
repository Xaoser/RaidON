...
public record RaidGuiSettings(
    ...
    public static final RaidGuiSettings DEFAULT = new RaidGuiSettings(null, null, null, null, DEFAULT_WIDTH, DEFAULT_HEIGHT);
    ...
    public RaidGuiSettings(@Nullable ResourceLocation mainTexture, @Nullable ResourceLocation progressTexture, int width, int height) {
        this(mainTexture, progressTexture, null, null, width, height);
    }
